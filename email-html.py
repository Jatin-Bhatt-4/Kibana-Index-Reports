...
def main():
    ...
    # Call function to send email with HTML attachment
    send_email('kibana@email.com', 'jatinbhatt@email.com', f'Kibana Index Size(KB) Report {datetime.now().strftime("%d-%m-%Y")}', html_file_name)


# Function to send email with HTML attachment
def send_email(fromaddr, toaddr, subject, html_file_name):
    ...
    # Attach HTML content as text/html part
